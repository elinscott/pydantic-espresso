"""Test `pydantic_espresso.card.pw.k_points`."""

import numpy as np

from pydantic_espresso.card.pw.k_points import KPointsGammaCard, KPointsGridCard, KPointsListCard


def test_kpoints_gamma_card() -> None:
...
def test_kpoints_grid_card() -> None:
...
def test_kpoints_list_card() -> None:
    """Test the KPointsListCard class."""
    card = KPointsListCard(
        k_points=[
