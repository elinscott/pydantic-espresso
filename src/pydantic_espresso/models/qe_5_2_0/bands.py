"""Pydantic model for the input of `bands.x` version `qe-5.2.0`.
...
class BandsNamelist(Namelist):
    ...
    lp: bool = Field(False, description="If .true. matrix elements of the momentum operator p between conduction and valence bands are written to file 'filp")
