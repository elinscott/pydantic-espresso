"""Pydantic model for the input of `bands.x` version `qe-6.7MaX-Release`.
...
class BandsNamelist(Namelist):
    ...
    lp: bool = Field(False, description="If .true. matrix elements of the momentum operator p between conduction and valence bands are computed and written to file specified in filp")
