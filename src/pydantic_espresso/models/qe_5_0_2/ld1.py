...
class InputpNamelist(Namelist):
    ...
    file_recon: str | None = Field(None, description="File containing data needed for GIPAW reconstruction of all-electron wavefunctions from PP results. If you want to use additional states to perform the reconstruction, add them at the end of the list of all-electron states.")
    ...
    lsave_wfc: bool | None = Field(None, description="Set it to .true. to save all-electron and pseudo wavefunctions used in the pseudo-potential generation in the UPF file. Only works for UPFv2 format.")
    ...
    file_wfcaegen: str | None = Field(None, description="file with the all-electron wfc for generation")
    file_wfcncgen: str | None = Field(None, description="file with the norm-conserving wfc for generation")
    file_wfcusgen: str | None = Field(None, description="file with the ultra-soft wfc for generation")
