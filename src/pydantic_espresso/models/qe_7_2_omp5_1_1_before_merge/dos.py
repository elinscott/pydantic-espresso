"""Pydantic model for the input of `dos.x` version `qe-7.2-omp5-1.1-before_merge`.
...
class DosNamelist(Namelist):
    ...
    bz_sum: Literal[None, "smearing", "tetrahedra", "tetrahedra_lin", "tetrahedra_opt"] = Field(None, description="Keyword selecting  the method for BZ summation. Available options are:")
