"""Pydantic model for the input of `ppacf.x` version `qe-7.2-omp5-1.1-before_merge`.
...
class PpacfNamelist(Namelist):
    ...
    outdir: Path = Field(Path("value of the"), description="directory containing the output data from pw.x, i.e. the same as in pw.x")
