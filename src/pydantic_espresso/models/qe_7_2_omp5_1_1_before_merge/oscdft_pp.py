"""Pydantic model for the input of `oscdft_pp.x` version `qe-7.2-omp5-1.1-before_merge`.
...
class OSCDFT_PPEspressoInput(EspressoInput):
    ...
    oscdft_pp_namelist: Oscdft_pp_namelistNamelist = Field(default_factory=Oscdft_pp_namelistNamelist)
