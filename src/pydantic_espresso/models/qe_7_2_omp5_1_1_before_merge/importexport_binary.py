...
class InputppNamelist(Namelist):
    ...
    newoutdir: str = Field("", description="directory into which the export data is going to be generated; after the 'import' phase, it can be then used as the outdir to restart for instance a pw.x NSCF calculation")
