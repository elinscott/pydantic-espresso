...
class Energy_currentNamelist(Namelist):
    ...
    delta_t: float = Field(1.e0, description="Small timestep used to do the numerical derivative needed in order to compute some parts of the current. Note that is in the pw.x units.")
    ...
    eta: float = Field(1.e0, description="Convergence parameter for Ewald-like sums")
    ...
    ethr_small_step: float = Field(1.e-7, description="Diagonalization threshold after the small delta_t numerical derivative step. (the system changed a very little)")
    ethr_big_step: float = Field(1.e-3, description="Diagonalization threshold at the beginning of each step but the first, for wich the pw.x input value is used.")
