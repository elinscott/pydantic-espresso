"""Pydantic model for the input of `all_currents.x` version `qe-7.2-omp5-1.1-before_merge`.
...
class ALL_CURRENTSEspressoInput(EspressoInput):
    ...
    energy_current: Energy_currentNamelist = Field(default_factory=Energy_currentNamelist)
