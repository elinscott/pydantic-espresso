"""Pydantic model for the input of `cp.x` version `qe-7.2-omp5-1.1-before_merge`.
...
class ControlNamelist(Namelist):
    ...
    ndw: int = Field(
        50,
        description="The restart files are write in the folder outdir/prefix_ndw.save/ where outdir, prefix and ndw are the input variables described in this document",
    )
    tabps: bool = Field(
        False,
