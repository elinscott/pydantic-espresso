"""Pydantic model for the input of `oscdft_et.x` version `qe-7.2-omp5-1.1-before_merge`.
...
class OSCDFT_ETEspressoInput(EspressoInput):
    ...
    oscdft_et_namelist: Oscdft_et_namelistNamelist = Field(default_factory=lambda: Oscdft_et_namelistNamelist())
