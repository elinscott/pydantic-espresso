"""Pydantic model for the input of `dynmat.x` version `qe-7.2-omp5-1.1-before_merge`.
...
class InputNamelist(Namelist):
    ...
    fileig: str | None = Field(None, description="output file containing phonon frequencies and eigenvectors of the dynamical matrix (they are orthogonal)")
