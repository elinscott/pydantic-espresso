"""Pydantic model for the input of `bgw2pw.x` version `qe-7.2-omp5-1.1-before_merge`.
...
class BGW2PWEspressoInput(EspressoInput):
    ...
    input_bgw2pw: Input_bgw2pwNamelist = Field(default_factory=Input_bgw2pwNamelist)
