"""Pydantic model for the input of `pprism.x` version `qe-7.2-omp5-1.1-before_merge`.
...
class InputppNamelist(Namelist):
    ...
    filplot: str | None = Field(None, description="file 'filplot' contains solvent's quantities (can be saved for further processing)")
