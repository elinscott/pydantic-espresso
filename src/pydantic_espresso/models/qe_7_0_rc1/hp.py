"""Pydantic model for the input of `hp.x` version `qe-7.0-rc1`.
...
class InputhpNamelist(Namelist):
    ...
    alpha_mix(i): float | None = Field(None, description="Mixing parameter (for the i-th iteration) for updating the response SCF potential using the modified Broyden method. See: D.D. Johnson, PRB 38, 12807 (1988) (https://journals.aps.org/prb/abstract/10.1103/PhysRevB.38.12807).")
    ...
    dist_thr: float | None = Field(None, description="Threshold (in Bohr) for comparing inter-atomic distances when reconstructing the missing elements of the response susceptibility in the post-processing step.")
