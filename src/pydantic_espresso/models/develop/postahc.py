...
class InputNamelist(Namelist):
    ...
    ahc_win_min_eV: float = Field(-1.e8, description="Lower bound of active AHC window for the lower Fan term in eV.")
    ahc_win_max_eV: float = Field(1.e8, description="Upper bound of active AHC window for the lower Fan term in eV.")
