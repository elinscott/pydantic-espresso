...
prebuilt_cards = {
    ...
    "constraints": {
        ...
        "default": "Field(default_factory=list)",
        "import_str": "from pydantic_espresso.models.pw.cards.constraints import Constraint",
    },
    "occupations": {
        ...
        "default": "Field(None)",
        "import_str": (
            "from pydantic_espresso.models.pw.cards.occupations import "
            "PositiveFloat0to1, PositiveFloat0to2"
        ),
    },
    "atomic_velocities": {
    ...
    "atomic_forces": {
        ...
        "default": "Field(default_factory=list)",
        "import_str": "from pydantic_espresso.models.pw.cards.atomic_forces import AtomicForce",
    },
    "solvents": {
    ...
    "hubbard": {
        ...
        "default": "Field(None)",
        "import_str": "from pydantic_espresso.models.pw.cards.hubbard import HubbardCard",
    },
}
