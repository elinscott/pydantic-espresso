...
class ControlNamelist(Namelist):
    ...
    disk_io: Literal[None, "high", "medium", "low", "nowf", "none"] = Field(
        None,
...
class SystemNamelist(Namelist):
    ...
    Hubbard_alpha: list[float] | None = Field(
        None,
        description="Hubbard_alpha(i) is the perturbation (on atom i, in eV) used to compute U (and V) with the linear-response method of Cococcioni and de Gironcoli, PRB 71, 035105 (2005) (https://journals.aps.org/prb/abstract/10.1103/PhysRevB.71.035105) (only for lda_plus_u_kind=0 and 2).  Note: Hubbard U and V can be computed using the HP code which is based on density-functional perturbation theory, and it gives exactly the same result as the method of Cococcioni and de Gironcoli. (start = 1, end = ntyp)",
    )
    Hubbard_beta: list[float] | None = Field(
        None,
        description="Hubbard_beta(i) is the perturbation (on atom i, in eV) used to compute J0 with the linear-response method of Cococcioni and de Gironcoli, PRB 71, 035105 (2005) (https://journals.aps.org/prb/abstract/10.1103/PhysRevB.71.035105) (only for lda_plus_u_kind=0 and 2). See also PRB 84, 115108 (2011) (https://journals.aps.org/prb/abstract/10.1103/PhysRevB.84.115108). (start = 1, end = ntyp)",
    )
