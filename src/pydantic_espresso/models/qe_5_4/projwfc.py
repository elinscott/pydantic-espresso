...
class ProjwfcNamelist(Namelist):
    ...
    irmin: int | None = Field(None, description="first point of the given box  BEWARE: irmin is a 2D array of the form: irmin(3,n_proj_boxes)")
    irmax: int | None = Field(None, description="last point of the given box; ( 0 stands for the last point in the FFT grid )  BEWARE: irmax is a 2D array of the form: irmax(3,n_proj_boxes)")
