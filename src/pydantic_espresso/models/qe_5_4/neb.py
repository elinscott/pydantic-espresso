...
class PathNamelist(Namelist):
    ...
    fcp_mu: float | None = Field(None, description="If lfcpopt = .TRUE., gives the target Fermi energy [Ry]. One can specify the total charge of the system for the first and last image by giving 'fcp_tot_charge_first' and 'fcp_tot_charge_last' so that the Fermi energy of these systems will be the target value, otherwise 'first_last_opt' should be .TRUE.")
    fcp_tot_charge_first: float | None = Field(None, description="Total charge of the system ('tot_charge') for the first image. Initial 'tot_charge' for intermediate images will be given by linear interpolation of 'fcp_tot_charge_first' and 'fcp_tot_charge_last")
    fcp_tot_charge_last: float | None = Field(None, description="Total charge of the system ('tot_charge') for the last image. Initial 'tot_charge' for intermediate images will be given by linear interpolation of 'fcp_tot_charge_first' and 'fcp_tot_charge_last")
