"""Pydantic model for the input of `hp.x` version `e6621af`.
...
class InputhpNamelist(Namelist):
    ...
    rmax: float | None = Field(None, description="Maximum distance (in Bohr) between two atoms to search neighbors (used only at the postprocessing step for DFT+U+V). This keyword is useful when there are e.g. defects in the system.")
    ...
    no_metq0: bool = Field(False, description="If .true. the metallic response term at q=0 is ignored (i.e. the last term in Eq. (22) in PRB 103, 045141 (2021) (https://journals.aps.org/prb/abstract/10.1103/PhysRevB.103.045141)). This is useful for magnetic insulators to avoid the divergence of the calculation.")
