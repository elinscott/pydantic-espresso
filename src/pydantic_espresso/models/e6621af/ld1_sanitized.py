"""Pydantic model for the input of `ld1.x` version `e6621af`.
...
class InputpNamelist(BaseModel):
...
class LD1EspressoInput(BaseModel):
    """Pydantic model for the input of `ld1.x.`"""

    Input: InputNamelist
    Inputp: InputpNamelist
    Test: TestNamelist
