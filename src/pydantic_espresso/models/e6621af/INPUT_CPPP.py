"""Pydantic model for the input of `cppp.x` version `e6621af`.
...
class CPPPEspressoInput(EspressoInputTemplate):
    ...
    nframes: int = Field( 1
         , description="number of MD step to be read to build the trajectory CURRENTLY MUST BE > 1")
    ndr: int = Field( 51
