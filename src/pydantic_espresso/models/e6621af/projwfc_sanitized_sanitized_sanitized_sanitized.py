...
class ProjwfcNamelist(BaseModel):
...
current directory ('./') otherwise", description="directory containing the input data, i.e. the same as in pw.x")
    ...
    filpdos: str = Field("(value of prefix variable)", description="prefix for output files containing PDOS(E)")
...
class PROJWFCEspressoInput(BaseModel):
