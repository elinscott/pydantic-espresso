"""Pydantic model for the input of `pw.x` version `qe-7.5-rc.1`.
...
class SystemNamelist(Namelist):
    ...
    vdw_corr: Literal["none", "grimme-d2", "grimme-d3", "TS", "MBD", "XDM"] = Field(
        "none",
        description="Type of the van der Waals correction. Allowed values: Note that non-local functionals (eg vdw-DF) are NOT specified here but in input_dft",
    )
